...
class Cell:
    ...
    def set_occupancy(self, occupied=True):
        ...
        #lab1_aux.set_occupancy(self, occupied)
...
class Astar:
    ...
    def get_path(self, start_idx, goal_idx):
        ...
        while open_list.not_empty():
            ...
            #cell.set_occupancy() 
            #print("bp1")   
            # !(settled) set the cell as visited
            cell.visited = True
            ...
            for nb_cell in self.get_free_neighbors(cell):
                tent_g_cost = cell.g_cost + Distance.from_separation(nb_cell.idx, cell.idx)
                #print("bp3")
                #print (cell)
                # print(len(open_list))
                ...
                # !(help) calculate the tentative g cost of getting from current cell (cell) to neighbouring cell (nb_cell)...
                # !(help)     use cell.g_cost and Distance.from_separation()
...
def subscribe_wheels(msg):
    global rbt_wheels
    rbt_wheels = Arjun_lab1_aux.subscribe_wheels(msg)
...
def gen_mask(cell_size, radius):
    ...
    while float(j) < radius_mapped:
        i_max = int64(sqrt(radius_mapped*radius_mapped-j*j))
...
# ================================ BEGIN ===========================================
MotionModel = Arjun_lab1_aux.OdometryMM
#LOS = lab2_aux.GeneralLOS
LOS = Arjun_lab1_aux.LOS
inverse_sensor_model = Arjun_lab1_aux.inverse_sensor_model
